  ...
  if (isLoggedIn) {
    menu = (
      <Menu onSelect={onSelect}>
        ...
        <MenuItem key="out">
          <Button>
            <IconOut fill="currentColor" width="20px" height="20px" />
            &nbsp;Sign Out
          </Button>
        </MenuItem>
      </Menu>
    ...
    menu = (
      <Menu onSelect={onSelect}>
        <MenuItem key="0" disabled>
          <Avatar src={avatar} alt="User avatar" loading="lazy" />
        </MenuItem>
        <MenuItem key="1" disabled>
          <Item>Register please</Item>
        </MenuItem>
        <MenuItem key="up">
          <Button>
            <IconRegister fill="currentColor" width="20px" height="20px" />
            &nbsp;Sign Up
          </Button>
        </MenuItem>
        <MenuItem key="in">
          <Button>
            <IconLogin fill="currentColor" width="20px" height="20px" />
            &nbsp;Sign In
          </Button>
        </MenuItem>
      </Menu>
  ...
  return (
    <Dropdown trigger={['click']} overlay={menu} animation="slide-up">
      <User
        title={
          isLoggedIn
            ? 'Сlick to view user information'
            : 'Сlick to authorization'
        }
      >
